...
@section('adminsection')
    ...
    <div class="overflow-x-auto">
        <a href="{{ route('createcrt') }}" class="btn btn-primary mb-3"><i class="fa-solid fa-plus"></i> Tambah</a>
        @if ($collection->count())
                    ...
                    <tbody>
                        @foreach ($collection as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('downloadcrt') }}" method="POST">
                                        @csrf
                                ...
                                <td class="d-flex">
                                    ...
                                    <form action="{{ route('destroycrt') }}" method="POST" class="px-1">
                                        @method('delete')
                                        @csrf
