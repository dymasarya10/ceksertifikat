        ...
        <div class="col">
            <div class="col d-flex justify-content-center align-items-center ">
                <div class="bg-white min-height-3-rem container-fluid rounded-4 shadow-lg mb-4 p-4">
                    ...
                    <form action="<?php echo e(route('checkdatacrt')); ?>" method="post" id="myForm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('front.templates.body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ceksertifikat\resources\views/front/pages/scancrt.blade.php ENDPATH**/ ?>