<?php $__env->startSection('adminsection'); ?>
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('storedch')); ?>" method="POST" class="pe-5" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('admin.templates.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ceksertifikat\resources\views/admin/pages/charters/create.blade.php ENDPATH**/ ?>