<?php $__env->startSection('adminsection'); ?>
    ...
    <form action="<?php echo e(route('storestd')); ?>" method="POST" class="pe-5">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('admin.templates.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ceksertifikat\resources\views/admin/pages/students/create.blade.php ENDPATH**/ ?>