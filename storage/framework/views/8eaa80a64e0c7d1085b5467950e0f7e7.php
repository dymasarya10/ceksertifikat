        ...
        <a class="col text-decoration-none text-black" href="/front/charter/scancht">
            <div class="col d-flex justify-content-center align-items-center ">
                <div class="bg-white text-center min-height-3-rem container-fluid rounded-4 shadow-lg mb-4 p-4">
                    <img src="<?php echo e(asset('assets/front/img/BARCODE.svg')); ?>" alt="" class="img-fluid w-75 text-center">
...
<?php echo $__env->make('front.templates.body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ceksertifikat\resources\views/front/pages/charter.blade.php ENDPATH**/ ?>